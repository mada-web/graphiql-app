...
const NotFound = (): JSX.Element => {
  ...
  return (
    <div className="w-screen h-screen flex items-center">
      <div className="grow max-w-7xl grid grid-cols-3 grid-rows-[200px_auto_140px] h-[500px] mx-auto inset-x-0 text-white bg-center bg-no-repeat  bg-[url('./bg_404.png')] bg-content rounded-[20px]">
