...
const Home = () => {
  return (
    <section className="bg-dark-blue inline-block md:h-[800px] min-[1366px]:h-screen h-[1200px] w-screen">
      <div className="flex flex-col justify-end items-end absolute w-screen md:h-[800px] min-[1366px]:h-screen h-[1200px]">
