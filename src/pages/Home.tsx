...
const Home = () => {
  return (
    <section className="inline-block h-[1470px] w-screen bg-dark-blue min-[395px]:h-[1420px] min-[465px]:h-[1400px] min-[585px]:h-[1350px] sm:h-[1300px] md:h-[1000px] min-[950px]:h-[900px] min-[1400px]:h-screen">
      <div className="absolute flex h-[1470px] w-screen flex-col items-end justify-end min-[395px]:h-[1420px] min-[465px]:h-[1400px] min-[585px]:h-[1350px] sm:h-[1300px] md:h-[1000px] min-[950px]:h-[900px] min-[1400px]:h-screen">
