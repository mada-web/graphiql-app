...
// const HeadersBlock = () => {
//   const { setHeadersParams, isHeadersParams, setIsHeadersParams } = useAppContext();
//   const headersRef = React.useRef() as React.MutableRefObject<HTMLDivElement>;
...
//       in={isHeadersParams}
//       timeout={500}
//       classNames="headers-block"
//       mountOnEnter
//       unmountOnExit
//     >
//       <section
//         ref={headersRef}
//         className="headers-block relative mr-2 h-[200px] w-[calc(100%-1rem)] rounded-t-lg bg-query transition-all sm:mr-0 sm:w-auto"
//       >
//         <h3 className="rounded-t-lg bg-green py-2 text-center text-black">headers</h3>
//         <span
//           className="absolute right-5 top-4 cursor-pointer px-2 font-sans"
//           onClick={closeHeaders}
//         >
//           <Close />
//         </span>
